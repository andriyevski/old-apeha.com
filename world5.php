...
<SCRIPT LANGUAGE=\"JavaScript\">
<!--
top.frames['main'].location = \"pomest.php\";
top.frames['online'].location = top.frames['online'].location;
top.frames['chat'].location = top.frames['chat'].location;
//-->
</SCRIPT>
        ...
        <tr>
          <td width='100%' height='100%' background='i/inman_fon.gif'>
            <table border='0' width='100%' height='100%' cellspacing='0' cellpadding='0' style='padding: 5'>
              <tr>
                <td width='50%' align='center'><img src=i/mir2_world/st4/logo.jpg alt='' border=1 galleryimg=no width=500 height=300></td>
...
echo "<div align='center'>
  <table border='1' background='i/inman_fon2.gif' cellpadding='0' cellspacing='0' style='border-collapse: collapse; border-style: solid; padding: 2' bordercolor='#D8C792' width='98%'>
    <tr>
      <td width='100%' align='center'>
Вы находитесь на <B>Улице №5</B> города <B>Evil City</B>, на этой улице вы сможете посетить такие здания как <B>Игорный дом</B> - Играем в кости, <b>Храм</b> - Тут вы можете обвенчатса.
</td>
    </tr>
  </table>
</div><br>";
...
echo "<div align='center'>
  <table border='1' background='i/inman_fon2.gif' cellpadding='0' cellspacing='0' style='border-collapse: collapse; border-style: solid; padding: 2' bordercolor='#D8C792' width='98%'>
    <tr>
      <td width='100%' colspan='2' align='center'><b>Улица №5:</b></td>
    </tr>
    <tr>
      <td width='50%' align='center'><input type=button class=input value='Игорный дом' onclick='top.frames[\"main\"].location =\" world5.php?room=12\"' ></td>
  <td width='50%' align='center'><input type=button class=input value='Церковь' onclick='top.frames[\"main\"].location = \"world5.php?room=16\"'></td>
    </tr>

<tr>
      <td width='50%' align='center'><input type=button class=input value='Поместье' onclick='top.frames[\"main\"].location =\" world5.php?room=50\"' ></td>
  </tr>
...
<td width='50%' align='center'><input type=button class=input value='<- Улица №4' onclick='top.frames[\"main\"].location = \"world2.php?room=35\"'></td>
      <td width='50%' align='center'><input disabled type=button class=input value='Врата города ->' onclick='top.frames[\"main\"].location = \"pruroda.php?room=62\"'></td>
      </tr>
  </table>
</div>
