...
<img src='i/inman_t20.gif' width='83' height='20' alt=''></td>
    <td background='i/inman_t21.gif' align='center'><a href='shop.php?otdel=100'><img src='i/shop/link_sale.gif'></a></td>
...
<b>Магазин</b></font>
  ...
  <tr>
    ...
    <td background='i/inman_t25.gif' align='center'><a href='shop.php?otdel=".$otdel."'><img src='i/shop/link_refresh.gif'></a></td>
...
<img src='i/inman_b213.gif' width='51' height='25' alt=''></td>
	...
	else include('inc/shop/_otdels_.php');
	if(!empty($lvl_itm))$lvls.="<option value=$lvl_itm>$lvl_itm</option>";
for($i=0;$i<=30;$i++){if($lvl_itm!=$i)$lvls.="<option value=$i>$i</option>";}
	echo"
</td>
...
<form action='?otdel=$otdel' method='post'><b><center>Товары для уровня:</center></b> <br><select width=30px name=lvl_itm>$lvls</select> <input type=submit value='Показать'></form>
  <tr>
      <td width='100%' colspan='2' align='center'><u>Оружие:</u></td>
    </tr>
    <tr>
      <td width='50%' align='center'><a href='?otdel=1'>Ножи</a></td>
      <td width='50%' align='center'><a href='?otdel=2'>Мечи</a></td>
    </tr>
    <tr>
      <td width='50%' align='center'><a href='?otdel=3'>Топоры</a></td>
      <td width='50%' align='center'><a href='?otdel=4'>Дубины</a></td>
    </tr>
  </table>
</div>
<br>
<div align='center'>
  <table border='1' background='i/inman_fon2.gif' cellpadding='0' cellspacing='0' style='border-collapse: collapse; border-style: solid; padding: 2' bordercolor='#D8C792' width='98%'>
    ...
    <tr>
      <td width='50%' align='center'><a href='?otdel=6'>Шлемы</a></td>
      <td width='50%' align='center'><a href='?otdel=7'>Лёгкая броня</a></td>
    </tr>
    <tr>
      <td width='50%' align='center'><a href='?otdel=8'>Тяжёлая броня</a></td>
      <td width='50%' align='center'><a href='?otdel=9'>Перчатки</a></td>
    </tr>
    <tr>
      <td width='50%' align='center'><a href='?otdel=16'>Нарукавники</a></td>
      <td width='50%' align='center'><a href='?otdel=10'>Щиты</a></td>
    </tr>
    <tr>
      <td width='50%' align='center'><a href='?otdel=11'>Пояса</a></td>
      <td width='50%' align='center'><a href='?otdel=12'>Обувь</a></td>
    </tr>
  </table>
</div>
<br>
...
<tr>
    ...
    <tr>
      <td width='33%' align='center'><a href='?otdel=13'>Ожерелья</a></td>
      <td width='33%' align='center'><a href='?otdel=14'>Кольца</a></td>
    </tr>
  </table>
</div>
<br>
...
<tr>
    ...
    <tr>
      <td width='50%' align='center'><a href='?otdel=18'>Свитки</a></td>
      <td width='50%' align='center'><a href='?otdel=19'>Зелья</a></td>
</tr>
<tr>
      <td width='100%' align='center' colspan='2'><a href='?otdel=22'>Рецепты</a></td>
    </tr>
  </table>
</div>
<br>
...
<tr>
    ...
    <tr>
      <td width='100%' align='center' colspan='2'><a href='?otdel=20'>Инструменты</a></td>
    </tr>
  </table>
</div>
