...
if ($access[$p] == 1) {
	...
	if (mysql_num_rows($inf_sel) == 1) {
		...
		$text = "<script language=JavaScript>show_inf(\"".$stat['user']."\",\"".$stat['id']."\",\"".$stat['level']."\",\"".$stat['rank']."\",\"".$stat['tribe']."\");</script> применил прием <b>\"Подлый удар\"</b> и тем самым нанес <b>$add_dmg_by_lvl</b> урона пермонажу $enemy<HR COLOR=e2e0e0>";
