...
// Групповые
$rase_1 = $stat["rase"] ;
if($rase_1=="1"){$rase_v="Люди";}
if($rase_1=="2"){$rase_v="Эльфы";}
if($rase_1=="3"){$rase_v="Орки";}
if($rase_1=="4"){$rase_v="Гномы";}
