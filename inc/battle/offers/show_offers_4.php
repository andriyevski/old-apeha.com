...
include("inc/battle/offers/forms_4.php");
...
if ($user_offer[time]) {
	...
	if ($user_offer[side] && $user_offer[type]==4)  echo"$s_b_form";
		...
		if ($user_offer[type]==4) { echo $s_c_form; }
