...
elseif ($stat['elik_sila'] > $now) $nms="Данное зелье ещё действует на Вас!";
	...
	insert_msg("Вы выпили зелье! И ваша сила увеличилась на +10 и будет такой еще 3 часа!","","","1",$stat['user'],"",$stat['room']);
	$nms="Вы выпили зелье! И ваша сила увеличилась на +10 и будет такой еще 3 часа!";
