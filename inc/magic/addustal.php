...
if ($chl['ustal_now'] >= $ustal_max) $nms="Персонаж \"".$chl['user']."\" не нуждается в зарядке!";
	...
	if ($stat[user]!="$chl[user]") $MesgForAdd = "Персонаж <b><u>$stat[user]</u></b> восстановил Вам уровень активности: <b><u>+$ustalplus<u></b> ед.";
	else $MesgForAdd = "Вы использовали ".$iteminfo['title']."... Удачно восстановлен Ваш уровень активности: <b><u>+$ustalplus</u></b> ед.";
