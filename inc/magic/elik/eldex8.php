...
elseif ($stat['elik_time'] > $now) $nms="Вы не можете пить более одного зелья сразу!";
	...
	$el_pow=0;
	$el_time=$now+3600;
	$nms="Вы выпили зелье! И ваша удача увеличилась на +8 и будет такой еще 1 час!";
	require_once("function/chat_insert.php");
	insert_msg("Вы выпили зелье! И ваша удача увеличилась на +8 и будет такой еще 1 час!","","","1",$stat['user'],"",$stat['room']);
