...
elseif ($stat['elik_time'] > $now) $nms="Вы не можете пить более одного зелья сразу!";
	...
	$el_pow=0;
	$el_time=$now+7200;
	$nms="Вы выпили зелье!И ваша сила увеличилась на +6 и будет такой еще 2 часа!";
	require_once("function/chat_insert.php");
	insert_msg("Вы выпили зелье!И ваша сила увеличилась на +6 и будет такой еще 2 часа!","","","1",$stat['user'],"",$stat['room']);
