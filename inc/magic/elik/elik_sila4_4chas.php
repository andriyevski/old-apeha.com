...
elseif ($stat['elik_time'] > $now) $nms="Вы не можете пить более одного зелья сразу!";
	...
	$el_pow=0;
	$el_time=$now+14400;
	$nms="Вы выпили зелье!И ваша сила увеличилась на +4 и будет такой еще 4 часа!";
	require_once("function/chat_insert.php");
	insert_msg("Вы выпили зелье!И ваша сила увеличилась на +4 и будет такой еще 4 часа!","","","1",$stat['user'],"",$stat['room']);
