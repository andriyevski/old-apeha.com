...
elseif (($for_add == 100 || $for_add == 200) && ($stat['proff'] == 1 && $stat['battle'] != $chl['battle'])) $nms="Для чтения заклинания на персонажа Вам необходимо находиться в одном бою ним!";
	...
	if ($chl['hp_now'] - $for_add <= 0){
		...
		$hpplus=$chl['hp_now'];}
			...
			if ($stat[user]!="$chl[user]") $MesgForAdd = "Маг <b><u>$stat[user]</u></b> использовал против вас воды воды... Холод поглотил ваши  жизни <b><u>-$hpplus НР</u></b>";
			else $MesgForAdd = "Наверное вы  недостаточно  обучены магии... Вы прочитали книгу магии воды и замёрзли  на ... : <b><u>-$hpplus НР</u></b>";
			...
			$nms="Свиток магии холода прочитан ...<br>Персонажа <u>".$chl['user']."</u> ударила волна холода и он замёрз на <u>-$hpplus HP</u>";
