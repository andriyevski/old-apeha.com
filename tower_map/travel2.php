...
<center>
<div id="info"
	style="overflow: auto; height: 180px; width: 420px; z-Index: 20;"></div>
	<?php include "trailer.php";?></center>
	<?php
...
function getmobs ($loc) {
	...
	$res = mysql_query ("SELECT name,image_path, (user = 'phaos_npc') as isnpc FROM players WHERE location = $loc AND user = 'phaos_npc' order by isnpc DESC ");
